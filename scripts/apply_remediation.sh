...
# The message is "apply PRISM remediation <id> (<time>): <first line of recordings/explain-v1-04/prism/remediation.md>";
...
file="$root/recordings/explain-v1-04/prism/remediation.md"
